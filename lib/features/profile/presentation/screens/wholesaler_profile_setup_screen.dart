// lib/features/profile/presentation/screens/wholesaler_profile_setup_screen.dart
...
class WholesalerProfileSetupScreen extends StatefulWidget {
  const WholesalerProfileSetupScreen({super.key});

  @override
  State<WholesalerProfileSetupScreen> createState() =>
      _WholesalerProfileSetupScreenState();
}

class _WholesalerProfileSetupScreenState
    extends State<WholesalerProfileSetupScreen> {
  ...
  Future<void> _submitProfile() async {
    ...
    try {
      ...
      // Update user document - mark profile as complete
      await FirebaseFirestore.instance
      ...
      if (mounted) {
        ...
        // Navigate back to first route (AuthWrapper will handle navigation)
        ...
        body: Form(
          ...
          child: ListView(
            ...
            children: [
              ...
              Text(
                'This information helps retailers and customers find your business',
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  helperText: 'Leave blank if operating as individual',
                ),
              ),
              const SizedBox(height: 24),
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  hintText: 'e.g., Specialty Chemicals, Rare Materials',
